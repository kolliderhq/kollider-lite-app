...
export const mod = (input1: TBigInput = '0', input2: TBigInput = '0') => {
	try {
...
export const fixed = (input: TBigInput = '0', places: number): string => {
	try {
...
export const gte = (input1: TBigInput = '0', input2: TBigInput = '0'): boolean => {
...
export const minus = (input1: TBigInput = '0', input2: TBigInput = '0', places = DEFAULT_PLACES) => {
	try {
...
export const multiply = (input1: TBigInput = '0', input2: TBigInput = '0', places = DEFAULT_PLACES) => {
	try {
...
export const divide = (input1: TBigInput = '0', input2: TBigInput = '1', places = DEFAULT_PLACES) => {
	try {
